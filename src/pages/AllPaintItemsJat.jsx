...
function AllPaintItemsJat(props) {
    const [paints, setPaints] = useState([]);

    useEffect(() => {
        const fetchPaints = async () => {
            try {
                const response = await axios.get('http://localhost:8080/api/paint/brand/Jat');
        ...
        <div className="shoppageback">
            ...
            <div id="content" className="shopItemsSection">
                ...
                <div >
                    ...
                    {/*    <Filteredpath />*/}
                    {/*</div>*/}
                    <h1 className="shopProductsHeading">Jat Paint Items</h1>
...
export default AllPaintItemsJat;
