...
function AllPaintItemsAccessories(props) {
    const [paints, setPaints] = useState([]);

    useEffect(() => {
        const fetchPaints = async () => {
            try {
                const response = await axios.get('http://localhost:8080/api/paint/category/Accessories');
    ...
    return (
        <div className="shoppageback">
            ...
            <div id="content" className="shopItemsSection">
                ...
                <div >
                    <h1 className="shopProductsHeading">Paint Accessories</h1>
...
export default AllPaintItemsAccessories;